  ...
  bootbox.confirm("Apakah Anda yakin ingin menghapus data ini?", function(result){
    ...
    if (result){
      ...
      $.post(url, {
        ...
        $('input:text[name=tgl_perawatan]').val("2023-08-07");
        $('input:text[name=tgl_registrasi]').val("2023-08-07");
        $('input:text[name=jam_rawat]').val("23:20:25");
...
$(document).ready(function () {
  ...
  $('.databarang_ajax').selectator({
    ...
    load: function (search, callback) {
      ...
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_ralan/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
  ...
  $('.master_aturan_pakai').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_ralan/ajax?show=aturan_pakai&aturan=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_ralan/ajax?show=jns_perawatan&nm_perawatan=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan_lab_ajax').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_ralan/ajax?show=jns_perawatan_lab&nm_perawatan=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan_rad_ajax').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_ralan/ajax?show=jns_perawatan_radiologi&nm_perawatan=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.icd10_').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_ralan/ajax?show=icd10&s=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.icd9_').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_ralan/ajax?show=icd9&s=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
