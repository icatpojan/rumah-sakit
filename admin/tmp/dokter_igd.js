  ...
  bootbox.confirm("Apakah Anda yakin ingin menghapus data ini?", function(result){
    ...
    if (result){
      ...
      $.post(url, {
        ...
        $('input:text[name=jam_rawat]').val("23:21:05");
...
$(document).ready(function () {
  ...
  $('.databarang_ajax').selectator({
    ...
    load: function (search, callback) {
      ...
      $.ajax({
        url: 'http://localhost/khanza-lite/admin/dokter_igd/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=64138475e196',
        type: 'GET',
        dataType: 'json',
